...
<html>
  ...
  <body>
    ...
    <main>
      <div id="music-bg-mobile">
        <div id="wrapper1">
          <h1>Keep Close</h1>
          <a href="music.html"><img id="album-art" src="images/album-art.png"></a>
          <h2>Available On:</h2>
          <div id="music-services" class="flex-container">
            <img src="images/spotify-black.svg">
            <img src="images/youtube-black.svg">
            <img src="images/itunes-black.svg">
        </div>
        <a id="listen-button" href="music.html">Listen</a>
    </div>
    <div class="horizontal-divider"></div>
      <div id="about" class="flex-container-large">
        <div id="about-text">
          <h1>About Us<br><br></h1>
          <p>Winter Wayfarer is a solo project by Collin Hop. Through the story that drives this conceptual series of music, I hope to be able to share with you the images I see in my head. This story follows a fictional tale of a heavily burdened character and her travels. Starting from the 1880s, the story maneuvers its way through the coming decades. Please join me in the development of this project!
          </p>
        </div>
      </div>
    </div>
      <div id="video-wrapper">
       <iframe width="560" height="315" src="https://www.youtube.com/embed/T7EJj8WqJsw/videoid?modestbranding=1&autohide=1&showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
